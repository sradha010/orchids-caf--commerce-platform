  ...
  return (
    <section id="contact" className="py-24 md:py-32 bg-[#3b2f1e]">
      <div className="container px-4 md:px-6 mx-auto">
        ...
        {/* FIX: Set grid-cols-1 for mobile and md:grid-cols-3 for horizontal layout */}
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          
          {/* Location Card */}
          <div className="group bg-[#4d3d28] rounded-2xl p-6 flex flex-col items-center text-center gap-4 transition-all hover:bg-[#5a4830] border border-transparent hover:border-[#6b8f5e]/30 hover:scale-[1.02]">
            ...
            <div className="flex flex-col h-full">
              ...
              <p className="text-[#c4a882] text-sm leading-relaxed mt-2 flex-grow">
              ...
              <a 
                ...
                className="inline-block text-[#6b8f5e] text-xs font-bold uppercase mt-4 hover:text-[#86b076] transition-colors cursor-pointer"
              >
                Get Directions →
              </a>
            </div>
          ...
          {/* Hours Card */}
          <div className="bg-[#4d3d28] rounded-2xl p-6 flex flex-col items-center text-center gap-4 border border-transparent hover:bg-[#5a4830] transition-all">
            <div className="w-12 h-12 bg-[#6b8f5e] rounded-full flex items-center justify-center shrink-0">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
